...
sealed class ComponentViewHolder(val view: View) : RecyclerView.ViewHolder(view) {
	...
	class TextFieldComponentViewHolder(
		...
		private val layout_error: TextInputLayout =
			view.findViewById(R.id.text_input_layout_filled_error)

		//	  private val layout: TextInputLayout = view.findViewById(R.id.text_input_layout_filled)
		//	  private val et_error: TextInputEditText = view.findViewById(R.id.text_input_edit_text_filled_error)
		//	  private val et: TextInputEditText = view.findViewById(R.id.text_input_edit_text_filled)
		override fun bind(component: Component) {
			super.bind(component)
			layout_error.error = "Error"
		}
	}
